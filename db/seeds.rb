...
math_questions = Question.create([
    { category_id: math.id, level: 1, correct_answer: "11", option1: "12", option2: "2", option3: "3", option4: "4", question: "What is 10 + 1?"  },
    { category_id: math.id, level: 1, correct_answer: "1300", option1: "13000", option2: "13", option3: "130", option4: "13100", question: "What is 100 * 13?"  },
    { category_id: math.id, level: 1, correct_answer: "16", option1: "14", option2: "144", option3: "1", option4: "126", question: "What is (12 / 3) * 4?" },
    { category_id: math.id, level: 1, correct_answer: "1", option1: "5", option2: "2", option3: "11", option4: "126", question: "What is 12 / (3 * 4)?"  },
    { category_id: math.id, level: 1, correct_answer: "50", option1: "25", option2: "501", option3: "100", option4: "150", question: "What is 0.5 * 100?" },
    { category_id: math.id, level: 1, correct_answer: "22", option1: "11", option2: "221", option3: "3", option4: "4", question: "What is 10 + 12?"  },
    { category_id: math.id, level: 1, correct_answer: "130", option1: "13000", option2: "131", option3: "130", option4: "1300", question: "What is 10 * 13?"  },
    { category_id: math.id, level: 1, correct_answer: "20", option1: "14", option2: "144", option3: "201", option4: "16", question: "What is (12 / 3) * 5?" },
    { category_id: math.id, level: 1, correct_answer: "1", option1: "5", option2: "2", option3: "12", option4: "16", question: "What is 15 / (3 * 5)?" },
    { category_id: math.id, level: 1, correct_answer: "25", option1: "251", option2: "50", option3: "100", option4: "150", question: "What is 0.25 * 100?" },
    { category_id: math.id, level: 2, correct_answer: "20", option1: "1", option2: "201", option3: "30", option4: "40", question: "What is (2 + 3) x (7 - 3)?" },
    { category_id: math.id, level: 2, correct_answer: "3", option1: "1", option2: "2", option3: "5", option4: "4", question: "What is 15 % of 20?" },
    { category_id: math.id, level: 2, correct_answer: "31", option1: "30", option2: "22", option3: "-6", option4: "60", question: "Solve:  2x - 37 = 25" },
    { category_id: math.id, level: 2, correct_answer: "15", option1: "16", option2: "12", option3: "13", option4: "14", question: "What is the value of the expression 3(x + 7)  when x = -2 ?" },
    { category_id: math.id, level: 2, correct_answer: "2", option1: "16", option2: "23", option3: "-2", option4: "-16", question: "  Solve:  4(x - 2) - 1 = 3x - 7" },
    { category_id: math.id, level: 2, correct_answer: "13", option1: "11", option2: "16", option3: "17", option4: "133", question: "What is the next term in the sequence 1, 4, 7, 10, …?" },
    { category_id: math.id, level: 2, correct_answer: "5", option1: "1/5", option2: "-1/5", option3: "53", option4: "-5", question: "What is the reciprocal of 1/5?" },  
    { category_id: math.id, level: 2, correct_answer: "32", option1: "31", option2: "320", option3: "-6", option4: "60", question: "Solve:  2x - 39 = 25" },
    { category_id: math.id, level: 2, correct_answer: "0", option1: "90", option2: "12", option3: "13", option4: "14", question: "What is the value of the expression 3(x + 7)  when x = -7 ?" },
    { category_id: math.id, level: 2, correct_answer: "4", option1: "16", option2: "40", option3: "-2", option4: "-16", question: "  Solve:  5 = 3x - 7"},
    { category_id: math.id, level: 3, correct_answer: "11", option1: "110", option2: "12", option3: "13", option4: "14", question: "What is square root of 121?" },
    { category_id: math.id, level: 3, correct_answer: "169", option1: "100", option2: "81", option3: "1690", option4: "121", question: "What is 13 square?" },
    { category_id: math.id, level: 3, correct_answer: "36", option1: "33", option2: "32", option3: "35", option4: "360", question: "What is the next number in the sequence:  1, 4, 9, 16, 25, __ ?" },
    { category_id: math.id, level: 3, correct_answer: "6", option1: "3", option2: "4", option3: "5", option4: "60", question: "The members of the gardening club are planting 40 tomato plants.  Each plant requires 2 stakes.  Stakes come in packages of 15.  How many packages of stakes will the club need to buy?" },
    { category_id: math.id, level: 3, correct_answer: "625", option1: "6259", option2: "475", option3: "550", option4: "721", question: "A survey company randomly called 200 people to get their opinion on a certain product. Of the 200 people, 125 liked the product and 75 did not like it. If this same trend continues, how many people should like the product out of 1000 people?" },
    { category_id: math.id, level: 3, correct_answer: "75", option1: "123", option2: "65", option3: "759", option4: "47", question: "One lunch period, popcorn sold at a rate of 5 bags every 3 minutes.  The lunch period lasted 45 minutes.  How many bags of popcorn were sold?" },
    { category_id: math.id, level: 3, correct_answer: "14", option1: "149", option2: "16", option3: "13", option4: "18", question: "The numbers of elk a ranger saw on 5 days are 12, 11, 8, 14, and 25.  What is the mean number of elk the ranger saw per day?" },
    { category_id: math.id, level: 3, correct_answer: "26", option1: "625", option2: "269", option3: "550", option4: "721", question: "What is square root of 676?" },
    { category_id: math.id, level: 3, correct_answer: "5", option1: "123", option2: "65", option3: "95", option4: "47", question: "What is cubic root of 125?" },
    { category_id: math.id, level: 3, correct_answer: "32", option1: "14", option2: "16", option3: "13", option4: "320", question: "What is square root of 1024?" }
])

history_questions = Question.create([
    {category_id: history.id, level: 1, correct_answer: "George Washington", option1: "John Adams", option2: "Abrahim Lincoln", option3: "Andrew Jackson", option4: "Thomas Jefferson", question: "Who was the first President of the United States?"},
    {category_id: history.id, level: 1, correct_answer: "The American Civil War", option1: "War of 1812", option2: "World War I", option3: "War of the world", option4: "The Revolutionary War ", question: "What war was fought on American soil from 1861 to 1865?"},
    {category_id: history.id, level: 1, correct_answer: "Abraham Lincoln", option1: "Barack Obama", option2: "Ulysses S. Grant", option3: "Barack Obama", option4: "Andrew Johnson", question: "Who was the 16th president of the US?"},
    {category_id: history.id, level: 1, correct_answer: "The Democrats", option1: "The liberals", option2: "The Federalists", option3: "The Progressives", option4: "The Independants", question: "Today in the United States government there are two major political parties.  The Republicians are one of the parties who is the other party?"},
    {category_id: history.id, level: 1, correct_answer: "Franklin D. Roosevelt", option1: "Dwight Eisenhower", option2: "Abrahim Lincoln", option3: "Herbert Hoover", option4: "Harry Truman ", question: "Who was the president from 1933 to 1945,  the only president to serve more than 8 years in office?"},
    {category_id: history.id, level: 1, correct_answer: "New York", option1: "Washington DC", option2: "Dallas", option3: "Seattle", option4: "Memphis", question: "In which city is the Empire State Building located?"},
    {category_id: history.id, level: 1, correct_answer: "Spanish", option1: "Chinese", option2: "French", option3: "Chinese", option4: "Hindi", question: "What is the second most spoken language in America?"},
    {category_id: history.id, level: 1, correct_answer: "Barack Obama", option1: " Abraham Lincoln", option2: "Ulysses S. Grant", option3: "James Buchanan", option4: "Andrew Johnson", question: "Who is the current president of America?"},
    {category_id: history.id, level: 1, correct_answer: "Christopher Columbus", option1: "Amerigo Vespucci", option2: "Newton", option3: "Francis Drake", option4: "Marco Polo", question: "Which explorer discovered America?"},
    {category_id: history.id, level: 1, correct_answer: "13", option1: "10", option2: "12", option3: "11", option4: "14 ", question: "How many stripes are displayed on the American flag?"},
    {category_id: history.id, level: 2, correct_answer: "Dallas", option1: "Memphis", option2: "1958", option3: "Austin", option4: "1973", question: "John F. Kennedy was assassinated in"},
    {category_id: history.id, level: 2, correct_answer: "Soviet Union", option1: "Russia", option2: "Japan", option3: "England", option4: "Germany", question: "Joseph Stalin was the premiere of what country?"},
    {category_id: history.id, level: 2, correct_answer: "England", option1: "Norway", option2: "Australia", option3: "Russia", option4: "France ", question: "The Battle of Hastings in 1066 was fought in which country? "},
    {category_id: history.id, level: 2, correct_answer: "Martin Luther", option1: "Voltaire", option2: "Henry David Thoreau", option3: "Saint Augustus", option4: "Abrahim Lincoln", question: "This man wrote a document known as the 95 Theses. "},
    {category_id: history.id, level: 2, correct_answer: "Marco Polo", option1: "Newton", option2: "Sir Francis Drake", option3: "Cook", option4: "Magellan", question: "Who was the first Western explorer to reach China?"},
    {category_id: history.id, level: 2, correct_answer: "Mongke Khan", option1: "Amair Khan", option2: "Salman Khan", option3: "Imran Khan", option4: "Mogee Khan", question: "Which was a Great Khan of Mongolia?"},
    {category_id: history.id, level: 2, correct_answer: "Queynisbrig", option1: "Counistoun", option2: "Dunri", option3: "Kingisburgh", option4: "oaklandburg", question: "What was the old Scottish name for Königsberg?"},
    {category_id: history.id, level: 2, correct_answer: "3rd Crusade", option1: "1st Crusade", option2: "2nd Crusade", option3: "5th Crusade", option4: "4th Crusade", question: "Friedrich Barbarossa died in 1190, to the great relief of Saladin, while travelling through Asia Minor on crusade. On which Crusade was this? "},
    {category_id: history.id, level: 2, correct_answer: "Corsica", option1: "French Guiana", option2: "Sardinia", option3: "Germany", option4: "Elba", question: "Where was Napoleon born?"},
    {category_id: history.id, level: 2, correct_answer: "Ethiopia", option1: "Libya", option2: "West Indies", option3: "Liberia", option4: "Eritrea", question: "In 1895 which African country defeated Italy allowing it to stay independent?"},
    {category_id: history.id, level: 3, correct_answer: "Andrew Jackson", option1: "Arthur Wellsley", option2: "Otto von Bismarck", option3: "Napoleon", option4: "Michael Jackson", question: "Who fought in the war of 1812?"},
    {category_id: history.id, level: 3, correct_answer: "Michael Jordan", option1: "Kobe Bryant", option2: "Tim Ducan", option3: "Magic Johnson", option4: "Michael Jackson", question: "After being cut from his high school basketball team, he went home locked himself in his room and cried"},
    {category_id: history.id, level: 3, correct_answer: "Albert Einstein", option1: "Charles Darwin", option2: "Galileo Galilei", option3: "Isaac Newton", option4: "Otto von Bismarck", question: "He wasn't able to speak until he was almost 4 years old and his teachers said he would never amount to much"},
    {category_id: history.id, level: 3, correct_answer: "Ronald Reagan", option1: "Abrahim Lincoln", option2: "George Washington", option3: "John Kennedy", option4: "William Harrison", question: "Who was the oldest elected president of USA?"},
    {category_id: history.id, level: 3, correct_answer: "Declaration of Independence", option1: "Articles of War", option2: "Declaration of new offices", option3: "U.S. Constitution", option4: "Bill of Rights", question: "Richard Henry Lee introduced a historic resolution at the Second Continental Congress. What resulted from this resolution?"},
    {category_id: history.id, level: 3, correct_answer: "France", option1: "India", option2: "Germany", option3: "Spain", option4: "Netherlands", question: "The United States was greatly helped in its war for independence by the actions of what European power?"},
    {category_id: history.id, level: 3, correct_answer: "The Roaring Twenties", option1: "The Twinklin' Twinklin Little star", option2: "The Kissin' Twenties", option3: "The Roaring Twenties", option4: "The Gay Twenties", question: "What was the decade from 1920 to 1929 referred to as?"},
    {category_id: history.id, level: 3, correct_answer: "1984", option1: "1986", option2: "1947", option3: "1967", option4: "1925", question: "When did Brunei become independent?"},
    {category_id: history.id, level: 3, correct_answer: "1963", option1: "1999", option2: "1966", option3: "1966", option4: "1977", question: "When was Malaysia formed?"},
    {category_id: history.id, level: 3, correct_answer: "Constantinople", option1: "Byzance", option2: "Adrienople", option3: "Nicosia", option4: "India", question: "What was the name of Istanbul before its capture by the Turks?"}

])


geography_questions = Question.create([
    { category_id: geography.id, level: 1, correct_answer: "Beijing", option1: "Khartoum", option2: "Karachi", option3: "Ottawa", option4: "Panama City", question: "What is the capital of China?"},
    { category_id: geography.id, level: 1, correct_answer: "New Delhi", option1: "Kolkata", option2: "Bombay", option3: "Bengaluru", option4: "Bihar", question: "What is the capital of India?"},
    { category_id: geography.id, level: 1, correct_answer: "Washington DC", option1: "Kansas City", option2: "Memphis", option3: "Germantown", option4: "Seattle", question: "What is the capital of United States of America?"},
    { category_id: geography.id, level: 1, correct_answer: "Islamabad", option1: "karachi", option2: "Lahore", option3: "Sukar", option4: "Hydrabad", question: "What is the capital of Pakistan?"},
    { category_id: geography.id, level: 1, correct_answer: "Tehran", option1: "Khartoum", option2: "Beijing", option3: "Riyadh", option4: "Amsterdam", question: "What is the capital of Iran?"},
    { category_id: geography.id, level: 1, correct_answer: "Abu Dhabi", option1: "Dubai", option2: "Beijing", option3: "Ottawa", option4: "Panama City", question: "What is the capital of United Arab Emirates?"},
    { category_id: geography.id, level: 1, correct_answer: "Abuja", option1: "kolkata", option2: "Bombay", option3: "Bengaluru", option4: "Riyadh", question: "What is the capital of Nigera?"},
    { category_id: geography.id, level: 1, correct_answer: "Addis Ababa", option1: "Kansas City", option2: "Memphis", option3: "Germantown", option4: "Riyadh", question: "What is the capital of Ethopia"},
    { category_id: geography.id, level: 1, correct_answer: "Amsterdam", option1: "karachi", option2: "Lahore", option3: "Riyadh", option4: "Hydrabad", question: "What is the capital of Netherlands?"},
    { category_id: geography.id, level: 1, correct_answer: "Baku", option1: "Khartoum", option2: "Beijing", option3: "Riyadh", option4: "Amsterdam", question: "What is the capital of Azerbaijan?"},
    { category_id: geography.id, level: 2, correct_answer: "Berlin", option1: "Khartoum", option2: "Riyadh", option3: "Ottawa", option4: "Panama City", question: "What is the capital of Germany?"},
    { category_id: geography.id, level: 2, correct_answer: "Belgrade", option1: "kolkata", option2: "Bombay", option3: "Bengaluru", option4: "Riyadh", question: "What is the capital of Serbia?"},
    { category_id: geography.id, level: 2, correct_answer: "Bern", option1: "Kansas ", option2: "Memphis", option3: "Germantown", option4: "Riyadh", question: "What is the capital of Switzerland?"},
    { category_id: geography.id, level: 2, correct_answer: "Brussels", option1: "Karachi", option2: "Lahore", option3: "Riyadh", option4: "Hydrabad", question: "What is the capital of Belgium?"},
    { category_id: geography.id, level: 2, correct_answer: "Bucharest", option1: "Khartoum", option2: "Beijing", option3: "Riyadh", option4: "Amsterdam", question: "What is the capital of Romania?"},
    { category_id: geography.id, level: 2, correct_answer: "Brasilia", option1: "Khartoum", option2: "Beijing", option3: "Ottawa", option4: "Riyadh", question: "What is the capital of Brazil?"},
    { category_id: geography.id, level: 2, correct_answer: "Bangkok", option1: "Kolkata", option2: "Bombay", option3: "Bengaluru", option4: "Riyadh", question: "What is the capital of Thailand?"},
    { category_id: geography.id, level: 2, correct_answer: "Bogota", option1: "Kansas City", option2: "Memphis", option3: "Germantown", option4: "Riyadh", question: "What is the capital of Colombia"},
    { category_id: geography.id, level: 2, correct_answer: "Bridgetown", option1: "Karachi", option2: "Lahore", option3: "Riyadh", option4: "Hydrabad", question: "What is the capital of Barbados?"},
    { category_id: geography.id, level: 2, correct_answer: "Bamako", option1: "Khartoum", option2: "Beijing", option3: "Riyadh", option4: "Amsterdam", question: "What is the capital of Mali?"},
    { category_id: geography.id, level: 3, correct_answer: "Copenhagen", option1: "Khartoum", option2: "Riyadh", option3: "Ottawa", option4: "Panama City", question: "What is the capital of Denmark?"},
    { category_id: geography.id, level: 3, correct_answer: "Dhaka", option1: "kolkata", option2: "Bombay", option3: "Bengaluru", option4: "Riyadh", question: "What is the capital of Bangladesh?"},
    { category_id: geography.id, level: 3, correct_answer: "Dakar", option1: "Kansas City", option2: "Memphis", option3: "Germantown", option4: "Riyadh", question: "What is the capital of Senegal?"},
    { category_id: geography.id, level: 3, correct_answer: "Canberra", option1: "Karachi", option2: "Lahore", option3: "Riyadh", option4: "Hydrabad", question: "What is the capital of Australia?"},
    { category_id: geography.id, level: 3, correct_answer: "Caracas", option1: "Khartoum", option2: "Beijing", option3: "Riyadh", option4: "Amsterdam", question: "What is the capital of Venezuela?"},
    { category_id: geography.id, level: 3, correct_answer: "Doha", option1: "Khartoum", option2: "Riyadh", option3: "Ottawa", option4: "Panama City", question: "What is the capital of Qatar?"},
    { category_id: geography.id, level: 3, correct_answer: "Dublin", option1: "Kolkata", option2: "Bombay", option3: "Bengaluru", option4: "Riyadh", question: "What is the capital of Ireland?"},
    { category_id: geography.id, level: 3, correct_answer: "Hagatna", option1: "Kansas City", option2: "Memphis", option3: "Germantown", option4: "Riyadh", question: "What is the capital of Guam?"},
    { category_id: geography.id, level: 3, correct_answer: "Kuala Lumpur", option1: "karachi", option2: "Lahore", option3: "Riyadh", option4: "Hydrabad", question: "What is the capital of Malaysia?"},
    { category_id: geography.id, level: 3, correct_answer: "Kathmandu", option1: "Khartoum", option2: "Beijing", option3: "Riyadh", option4: "Amsterdam", question: "What is the capital of Nepal?"}
...
{ category_id: animal.id, mediaurl:"24_animal_red_deer.jpg", level: 3, correct_answer: "Red Deer", option1: "Sheep", option2: "Dog", option3: "Monkey", option4: "Lion", question: "Name the animal shown in the picture?"},
...
{ category_id: animal.id, mediaurl:"27_animal_gazelle.jpg", level: 3, correct_answer: "Gazelle", option1: "Sheep", option2: "Dog", option3: "Monkey", option4: "Lion", question: "Name the animal shown in the picture?"},
