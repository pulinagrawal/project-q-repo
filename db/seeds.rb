...
{ category_id: animal.id, mediaurl:"2_animal_tiger.jpg", level: 1, correct_answer: "Tiger", option1: "Tiger", option2: "Dog", option3: "Monkey", option4: "lion", question: "Name the animal shown in the picture?"},
{ category_id: animal.id, mediaurl:"3_animal_elephant.jpg", level: 1, correct_answer: "Elephant", option1: "Cat", option2: "Dog", option3: "Elephant", option4: "Lion", question: "Name the animal shown in the picture?"},
{ category_id: animal.id, mediaurl:"4_animal_horse.jpg", level: 1, correct_answer: "Horse", option1: "Cat", option2: "Dog", option3: "Monkey", option4: "Horse", question: "Name the animal shown in the picture?"},
{ category_id: animal.id, mediaurl:"5_animal_monkey.jpg", level: 1, correct_answer: "Monkey", option1: "Cat", option2: "Dog", option3: "Monkey", option4: "Lion", question: "Name the animal shown in the picture?"},
{ category_id: animal.id, mediaurl:"6_animal_cat.jpg", level: 1, correct_answer: "Cat", option1: "Cat", option2: "Dog", option3: "Monkey", option4: "Lion", question: "Name the animal shown in the picture?"},
...
{ category_id: animal.id, mediaurl:"14_animal_giraffe.jpg", level: 2, correct_answer: "Giraffe", option1: "Cat", option2: "Dog", option3: "Giraffe", option4: "Lion", question: "Name the animal shown in the picture?"},
{ category_id: animal.id, mediaurl:"15_animal_leopard.jpg", level: 2, correct_answer: "Leopard", option1: "Cat", option2: "Dog", option3: "Leopard", option4: "Lion", question: "Name the animal shown in the picture?"},
{ category_id: animal.id, mediaurl:"16_animal_cheetah.jpg", level: 2, correct_answer: "Cheetah", option1: "Cat", option2: "Dog", option3: "Cheetah", option4: "Lion", question: "Name the animal shown in the picture?"},
{ category_id: animal.id, mediaurl:"17_animal_alligator.jpg", level: 2, correct_answer: "Alligator", option1: "Cat", option2: "Dog", option3: "Alligator", option4: "Lion", question: "Name the animal shown in the picture?"},
{ category_id: animal.id, mediaurl:"18_animal_jaguar.jpg", level: 2, correct_answer: "Jaguar", option1: "Cat", option2: "Dog", option3: "Jaguar", option4: "Lion", question: "Name the animal shown in the picture?"},
...
{ category_id: logo.id, mediaurl:"logo_amazon.jpg", level: 1, correct_answer: "Amazon", option1: "Amazon", option2: "Samsung", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_android.jpg", level: 1, correct_answer: "Android", option1: "Android", option2: "Samsung", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_angry_birds.jpg", level: 1, correct_answer: "Angry Birds", option1: "Angry Birds", option2: "Samsung", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_apple.jpg", level: 1, correct_answer: "Apple", option1: "Apple", option2: "Samsung", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_caterpillar.jpg", level: 1, correct_answer: "Caterpillar", option1: "Caterpillar", option2: "Samsung", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_dominos_pizza.jpg", level: 1, correct_answer: "Dominos Pizza", option1: "Dominos pizza", option2: "Samsung", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_facebook.jpg", level: 1, correct_answer: "Facebook", option1: "Facebook", option2: "Samsung", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_google.jpg", level: 1, correct_answer: "Google", option1: "Nike", option2: "Google", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_harley_davidson.jpg", level: 1, correct_answer: "Harley Davidson", option1: "Nike", option2: "Harley Davidson", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_history_channel.jpg", level: 1, correct_answer: "History Channel", option1: "Nike", option2: "Samsung", option3: "History Channel", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_hsbc.jpg", level: 2, correct_answer: "HSBC", option1: "Nike", option2: "Samsung", option3: "Pizza Hut", option4: "HSBC", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_ikea.jpg", level: 2, correct_answer: "Ikea", option1: "Nike", option2: "Samsung", option3: "Pizza Hut", option4: "Ikea", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_intel.jpg", level: 2, correct_answer: "Intel", option1: "Nike", option2: "Samsung", option3: "Intel", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_itunes.jpg", level: 2, correct_answer: "Itunes", option1: "Nike", option2: "Itunes", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_kfc.jpg", level: 2, correct_answer: "KFC", option1: "Nike", option2: "KFC", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_mcdonalds.jpg", level: 2, correct_answer: "McDonalds", option1: "McDonalds", option2: "Samsung", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_mercedes.jpg", level: 2, correct_answer: "Mercedes", option1: "Nike", option2: "Mercedes", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_microsoft.jpg", level: 2, correct_answer: "Microsoft", option1: "Nike", option2: "Samsung", option3: "Microsoft", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_msn.jpg", level: 2, correct_answer: "MSN", option1: "Nike", option2: "Samsung", option3: "MSN", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_nike.jpg", level: 2, correct_answer: "Nike", option1: "Nike", option2: "Samsung", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_pepsi.jpg", level: 3, correct_answer: "Pepsi", option1: "Pepsi", option2: "Samsung", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_pizza_hut.jpg", level: 3, correct_answer: "Pizza Hut", option1: "Nike", option2: "Samsung", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_pringles.jpg", level: 3, correct_answer: "Pringles", option1: "Nike", option2: "Pringles", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_redbull.jpg", level: 3, correct_answer: "Red Bull", option1: "Nike", option2: "Red Bull", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_samsung.jpg", level: 3, correct_answer: "Samsung", option1: "Nike", option2: "Samsung", option3: "Samsung", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_shell.jpg", level: 3, correct_answer: "Shell", option1: "Nike", option2: "Samsung", option3: "Pizza Hut", option4: "Shell", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_starbucks.jpg", level: 3, correct_answer: "Starbucks", option1: "Nike", option2: "Samsung", option3: "Starbucks", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_subway.jpg", level: 3, correct_answer: "Subway", option1: "Nike", option2: "Subway", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
{ category_id: logo.id, mediaurl:"logo_tmobile.jpg", level: 3, correct_answer: "Tmobile", option1: "Tmobile", option2: "Samsung", option3: "Pizza Hut", option4: "Google", question: "Name the company whose logo is shown in the picture?"},
...
sport_questions = Question.create([
    ...
    { category_id: sport.id, level: 3, correct_answer: "Stumped", option1: "Stumped", option2: "DDLJ", option3: "Dil Se", option4: "Chak de India", question: "Tendulkar featured in which Bollywood film?"},
    { category_id: sport.id, level: 3, correct_answer: "Rawalpindi Express", option1: "Fast Tiger", option2: "Rawalpindi Express", option3: "Don", option4: "The Eagle", question: "What is Shoaib Akhtars nickname?"},
    { category_id: sport.id, level: 3, correct_answer: "Pakistan", option1: "UAE", option2: "South Africa", option3: "Kenya", option4: "Pakistan", question: "Against which team did Sachin play his last ODI?"},
    { category_id: sport.id, level: 3, correct_answer: "Pakistan", option1: "New Zealand", option2: "Australia", option3: "Bangladesh", option4: "Pakistan", question: "Against which team did Sachin Tendulkar make his test debut?"},
    { category_id: sport.id, level: 3, correct_answer: "2003", option1: "1999", option2: "1997", option3: "2004", option4: "2003", question: "When did Sachin receive the Wisden cricketer of the year award?"}
